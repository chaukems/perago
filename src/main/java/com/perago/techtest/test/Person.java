...
public class Person implements Serializable, Diffable<Person> {
    ...
    public DiffResult diff(Person obj) {
        return new DiffBuilder(this, obj, ToStringStyle.SHORT_PREFIX_STYLE)
                ...
                .append("surname", this.surname, obj.surname)
                .append("friend", this.friend, obj.friend)
                .append("pet", this.pet, obj.pet)
                .append("nickNames", this.nickNames, obj.nickNames)
                .build();
    }
}
